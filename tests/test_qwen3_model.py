...
def _run_model_forward(model_name: str, iters: int = 10):
    mlx_model, tokenizer = load(model_name)
    model = Qwen3DenseModel(mlx_model)
...
def test_forward_qwen3_0_6b():
    _run_model_forward("Qwen/Qwen3-0.6B-MLX-4bit", 5)
...
def test_forward_qwen3_4b():
    _run_model_forward("Qwen/Qwen3-4B-MLX-4bit", 1)


@pytest.mark.skipif(
    not qwen3_1_7b_model_exists(), reason="Qwen3-1.7B-4bit model not found"
)
def test_forward_qwen3_1_7b():
    _run_model_forward("Qwen/Qwen3-1.7B-MLX-4bit", 3)
...
def test_incremental_decode_qwen3_0_6b():
    _run_incremental_decode("Qwen/Qwen3-0.6B-MLX-4bit", seq_len=3)


@pytest.mark.skipif(
    not qwen3_4b_model_exists(), reason="Qwen3-4B-4bit model not found"
)
def test_incremental_decode_qwen3_4b():
...
def test_incremental_decode_qwen3_1_7b():
    _run_incremental_decode("Qwen/Qwen3-1.7B-MLX-4bit", seq_len=3)
